  ...
  return (
    <div className="grid grid-cols-2 bg-[url('/fw12.webp')] bg-no-repeat bg-center bg-contain px-[5rem] py-[6rem]">
      ...
      <div className="px-10 flex flex-col justify-between relative">
        <div className="my-1">
          <div className="educationBar before:w-[40%]"></div>
          <p className="text-sm font-body font-semibold mt-1 tracking-wide ">
            OUTSOURCING EDUCATION
            <span className="educationBarSpan font-body">60%</span>
          </p>
        </div>
        <div className="my-1">
          <div className="educationBar before:w-[35%]"></div>
          <p className="text-sm font-body font-semibold mt-1 tracking-wide ">
            BUSINESS DEVELOPMENT
            <span className="educationBarSpan font-body">50%</span>
          </p>
        </div>
        <div className="my-1">
          <div className={`educationBar before:w-[28%]`}></div>
          <p className="text-sm font-body font-semibold mt-1 tracking-wide ">
            CREATIVE DESIGN
            <span className="educationBarSpan font-body">80%</span>
          </p>
        </div>
        <div className="my-1">
          <div className="educationBar before:w-[26%]"></div>
          <p className="text-sm font-body font-semibold mt-1 tracking-wide ">
            SOCIAL STUDIES
            <span className="educationBarSpan font-body">70%</span>
          </p>
        </div>
        <div className="my-1">
          <div className="educationBar before:w-[31%]"></div>
          <p className="text-sm font-body font-semibold mt-1 tracking-wide ">
            TECHNICAL STUDIES
            <span className="educationBarSpan font-body">35%</span>
          </p>
        </div>
      </div>
    </div>
