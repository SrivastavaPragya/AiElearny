...
// export default CoursesForU

"use client";

import { useState } from "react";

export const CoursesForU = () => {
  const [active, setActive] = useState(1);

  const CommonComponent1 = ({ heading }) => {
    return (
  ...
  return (
    <div className=" flex item-center justify-start bg-[url('/fw13.jpg')] bg-no-repeat bg-center bg-cover px-[4rem] py-[6rem]">
      <div className=" w-[10%]">
        <ul
          className={`w-[100%] h-full flex flex-col items-end justify-center learningAllList2`}
        >
          <li
            className={`learningList2 firstLink2`}
            onClick={() => setActive(1)}
          >
            <p
              className={`learningLink2 
               ${active === 1 && "currentLink"}
               `}
            >
              <span className="learningNumber"> 1/4</span>
            </p>
          </li>
          <li
            className={`learningList2 secondLink2`}
            onClick={() => setActive(2)}
          >
            <p
              className={`learningLink2 
                ${active === 2 && "currentLink"}
               `}
            >
              <span className="learningNumber"> 2/4</span>
            </p>
          </li>
          <li
            className={`learningList2 thirdLink2`}
            onClick={() => setActive(3)}
          >
            <p
              className={`learningLink2 
               ...
               `}
            >
              <span className="learningNumber"> 3/4</span>
            </p>
          </li>
          <li
            className={`learningList2 fourthLink2`}
            onClick={() => setActive(4)}
          >
            <p
              className={`learningLink2
                ${active === 4 && "currentLink"}
               `}
            >
              <span className="learningNumber"> 4/4</span>
            </p>
          </li>
        </ul>
      </div>
