  ...
  return (
    ...
    >
      ...
      <div className="w-[40%] ">
        ...
        <button
          className={`opacity-0 homebtn relative bottom-5 ${
      ...
      <div className="w-[60%] grid grid-cols-3 grid-rows-2 overflow-hidden">
        {/* 1 */}
        <div
          className={`opacity-0 flex flex-col items-center justify-center teamProfile ${
            inView && "animate-slide-in-from-left"
          } animate-delay-250`}
        >
          <div className="rounded-full w-[143px] h-[143px] object-contain mb-1 teamProfileImg">
            <img
              src="/lauren.jpg"
        ...
        >
          <div className="rounded-full w-[143px] h-[143px] object-contain mb-1 flex flex-col items-center cursor-pointer justify-center bg-[#00ECA3]">
