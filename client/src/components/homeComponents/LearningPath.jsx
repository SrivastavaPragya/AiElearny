...
const LearningPath = () => {
    ...
    return (
      <div className=" py-5 px-24 w-[50%] text-left">
        ...
        <div className="my-6">
          ...
          <button
            className={`homebtn relative bottom-5 ${
  ...
  const CommonComponent2 = ({ path1, path2 }) => {
    return (
      <div className="p-4 pl-10 w-[50%] h-full flex justify-center items-center">
        <div className={`figure1`}>
          <div className={`blueFigure`}></div>
          <div
            className={`h-[30rem] object-contain rounded-xl overflow-hidden shadow-lg learningImgContainer1 ${
        ...
        <div className={`mt-10 mx-7 figure2`}>
          <div className={`blueFigure2`}></div>
          <div
            className={`h-[30rem] object-contain rounded-xl overflow-hidden shadow-lg learningImgContainer2 ${
              inView && "animate-slide-in-from-bottom"
            }`}
          >
  ...
  return (
    ...
    >
      ...
      <ul className={`mt-10  w-[50%] m-auto flex learningAllList`}>
        <li className={`learningList firstLink`} onClick={() => setActive(1)}>
          <p className={`learningLink ${active === 1 && "currentLink"} `}>
            Creating a Better Future For you
          </p>
        </li>
        <li className={`learningList secondLink`} onClick={() => setActive(2)}>
          <p className={`learningLink ${active === 2 && "currentLink"} `}>
            Learn why eLearny is Best
          </p>
        </li>
        <li className={`learningList thirdLink`} onClick={() => setActive(3)}>
          <p className={`learningLink ${active === 3 && "currentLink"} `}>
