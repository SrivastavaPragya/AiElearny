...
const ModernTechniques = () => {
  return (
    <div className="bg-[url(/fw12.webp)] bg-cover bg-no-repeat px-[4rem] py-[6rem] flex">
      <div className={`w-[25rem] h-[25rem] mx-auto  ImageContainer`}>
        <div className={`object-contain w-[25rem] h-[25rem] techniqueImage`}>
          <img
            src="girl-headphone.webp"
            className={`w-full h-full servicesImage`}
            alt=""
          />
        </div>
      </div>
