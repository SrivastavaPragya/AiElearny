  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 grid-rows-2 gap-6 my-[5rem] px-[4rem]">
        <div
          className={`py-10 px-[4rem] text-center bg-[#fafafa] rounded-lg allServices hover:shadow-2xl`}
        >
        ...
        <div
          className={`py-10 px-[2rem] text-center bg-[#fafafa] rounded-lg  allServices hover:shadow-2xl`}
        >
